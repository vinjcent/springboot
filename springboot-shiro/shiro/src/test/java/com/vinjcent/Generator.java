...
public class Generator {
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"viewrole", "viewperm"};
